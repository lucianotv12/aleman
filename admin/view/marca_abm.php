			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Marca : <?php echo @$marca->nombre?></h4>
                        </div>
                        <div class="panel-body">
  							<?php if($cambio == "new"):?>
    		  					<form name="marca_cambio" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>marca_insert.html">
                                
		  					<?php else:?>
	    					    <form name="marca" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>marca_update/<?php echo $_GET['id'];?>/">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <?php foreach($proveedores as $proveedor):?>
                                            <option value="<?php echo $proveedor['id']?>" <?php if(@$proveedorId == $proveedor['id']) echo "selected"; ?> > <?php echo $proveedor['nombre']?></option>
                                        <?php endforeach;?> 
                                        </select>
                                    </div>
                                </div>           
