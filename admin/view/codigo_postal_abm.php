			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">CP : </h4>
                        </div>
                        <div class="panel-body">
  							<?php if($cambio == "new"):?>
		  					<form name="codigo_postal_cambio" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>codigo_postal_insert.html">
		  					<?php else:?>
		  					<form name="codigo_postal_cambio" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>codigo_postal_update/<?php echo $codigo_postal["id"]?>/">
		  					<input name="_idProducto" type="hidden" value="<?php echo $_GET['id'];?>">
		  					<?php endif;?>	

                            
                                <div class="form-group">
                                    <label class="col-md-3 control-label">CP desde</label>
                                    <div class="col-md-9">
									<input type="number" class="form-control" name="cp_desde" value="<?php echo @$codigo_postal["cp_desde"]?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">CP hasta</label>
                                    <div class="col-md-9">
									<input type="number" class="form-control" name="cp_hasta" value="<?php echo @$codigo_postal["cp_hasta"]?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-3 control-label">VALOR</label>
                                    <div class="col-md-9">
									<input type="number" class="form-control" name="valor" value="<?php echo @$codigo_postal["valor"]?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
										<select name="active">
											<option value="1" <?php if(@$codigo_postal["active"] == "1") echo "selected"; ?> >Activo</option>
											<option value="0" <?php if(@$codigo_postal["active"] == "0") echo "selected"; ?>>No activo</option>
										</select>
                                    </div>
                                </div>  
								<div class="form-group">
