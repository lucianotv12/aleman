								...
								//	$precio_total = $compra["precio_total_productos"] + $compra["precio_total_envio"];
									?>
										<tr style="color:gray;font-size: 11px">
											<td><?php echo $envio["idCompra"] . $envio["id"];?></td>
											<td><?php echo $envio["id"];?></td>
											<td><?php echo $envio["idCompra"];?></td>
											<td><?php echo $envio["producto"];?></td>
											<td><?php echo $envio["usuario"];?></td>
											<td><?php echo $envio["email"];?></td>
											<td><?php echo $envio["cantidad"];?></td>
											<td><?php echo $envio["date"];?></td>
											<td><?php echo $envio["status_urbano"];?></td>
										</tr>
									<?php endforeach;?>
