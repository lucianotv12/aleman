			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><?php echo @$titulo?> - Marcas</h4>
                        </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead>
						          <?php if($_usuario->gerarquia == 1): ?>
                                	...
                                	<tr><th ><a href="<?php echo HOME?>marca_new.html">NUEVA MARCA</a></th></tr>
                                  <?php endif;?>	
                                ...
                                <tbody>
									<?php foreach($marcas as $marca):?>
										<tr style="color:gray;font-size: 11px">
											...
											<td><?php echo $marca["proveedor"];?></td>
											<td><?php if($proveedor["active"] == 1) echo "Activo"; else echo "No Activo"; ?></td>
    									    <?php if($_usuario->gerarquia == 1): ?>									
											<td><a href="<?php echo HOME?>marca_edit/<?php echo $marca["id"];?>/">Ver mas</td>
											<td>
											<?php endif;?>	
										</tr>
									<?php endforeach;?>
