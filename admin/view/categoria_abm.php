			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Categoria : <?php print_r(@$categoria["nombre"]);?></h4>
                        </div>
                        <div class="panel-body">
  							<?php if($cambio == "new"):?>
		  					<form name="categoria_cambio" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>categoria_insert.html">
		  					<?php else:?>
		  					<form name="categoria_cambio" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>categoria_update/<?php echo $categoria["id"]?>/">
		  					...
		  					<?php endif;?>	
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
										<select name="active">
											<option value="1" <?php if(@$categoria["active"] == "1") echo "selected"; ?> >Activo</option>
											<option value="0" <?php if(@$categoria["active"] == "0") echo "selected"; ?>>No activo</option>
										</select>
                                    </div>
                                </div>  
								<div class="form-group">
