			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
		  					<form name="legales_update" enctype="multipart/form-data"  class="form-horizontal" method="post" action="<?php echo HOME?>config_update.html">
                                <input type="hidden" name="id_campania" value="<?php echo $campania['id']?>">
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Fecha Inicio</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control datepicker" name="fecha_inicio" value="<?php echo $campania['fecha_inicio']?>" >
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Fecha Fin</label>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control datepicker1" name="fecha_fin" value="<?php echo $campania['fecha_fin']?>">
                                    </div>
                                </div>                                   
