			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title"><?php echo @$titulo?> - Cuenta Corriente <span> CLIENTE : <?php if($cliente) echo $cliente->get_nombre();?> </span></h4>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="7">
                                            <form method="post" action="<?php echo ADMIN?>clientes_cc.html">
                                                <select name="proveedorId" id="proveedorId" onchange="submit()">    
                                                    <option value="0">Seleccione Cliente</option>
                                                    <?php foreach($clientes as $item):?>
                                                        <option value="<?php echo $item->id?>" <?php if($_cliente == $item->id) echo "selected";?>><?php echo $item->nombre?></option>
                                                     <?php endforeach;?>
                                                </select>
                                            </form>
                                	...
                                	<tr><th colspan="3">
                                                <a href="#"  data-toggle="modal" data-target="#nuevo_movimiento" style="color:blue">Nuevo movimiento Haber  </a>                                            
                                            </th>
                                            <th colspan="3">
                                                <a href="#"  data-toggle="modal" data-target="#nuevo_movimiento_haber" style="color:red">Nuevo movimiento Debe  </a>                                            
                                            </th></tr>                                        

                                    <tr style="font-size: 11px">
                                            <th style="background-color: #5DBD90;width: 30px">Id ref</th>
                                            <th style="background-color: #5DBD90;width: 30px">Fecha</th>                                            
                                            <th style="background-color: #5DBD90;width: 80px ">Factura</th>
                                            <th style="background-color: #5DBD90;width: 80px">Remito</th>
                                            <th style="background-color: #5DBD90;width: 150px">Detalle</th>
                                            <!--<th style="background-color: #5DBD90;">F.Deposito</th>-->
                                            <th style="background-color: #5DBD90;width: 80px">Debe</th>
                                            <th style="background-color: #5DBD90;width: 80px">Haber</th>
                                            <th style="background-color: #5DBD90;width: 80px">Saldo</th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <tr style="color:gray;font-size: 11px">
                                            ...
                                            <td><?php $date=date_create($factura["fecha"]); echo date_format($date, "d/m/Y");  ?></td>
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <form name="nuevo_movimiento" method="post" action="<?php echo HOME?>cliente_nuevo_movimiento_cc_haber.html">
	...
	<div class="modal fade" id="nuevo_movimiento" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	    ...
	    <div class="modal-dialog">
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <form name="nuevo_movimiento" method="post" action="<?php echo HOME?>cliente_nuevo_movimiento_cc.html">
