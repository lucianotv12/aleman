    ...
    function addTemporal()
    {
        ...
        //          var lucho = $(this).parent("tr").remove();
                ...
                //  var rows = table.getElementsByTagName("tr");   
                    ...
                    $('#mitabla tr:last').after("<tr id="+ numero +" width='100%'><td align='center' width='10%'><input type=text  name=cantidad"+ numero + " value=" + $('#cantidad').val() + "></td><td align='center' width='15%' ><input type=text name=idproducto"+ numero + "  value=" + $('#idproducto').val() + "></td><td align='left' width='35%'>"+desc+"</td><td align='center' width='15%' ><input type=text  name=precio_producto"+ numero + "  value=" + $('#precio_producto').val() + "></td><td align='center' width='10%' ><input  name=descuento_producto"+ numero + "  value=" + $('#descuento_producto').val() + "></td><td align='center' width='15%'><input type=text  name=precio_total"+ numero + " id=precio_total"+ numero + "  value=" + precio_total + " ></td><td><a href='#' onClick=$(this).parent().parent().remove();>Quitar</a></td></tr>"); 
