...
#				}
	...
	function producto_stock_abm($_PARAM, $_usuario_id=0){
		...
		$sql->execute(array("PRODUCTO"=> $_PARAM["idProducto"], "COMENTARIO" => $_PARAM['comentario'], "CANTIDAD"=> $_PARAM['cantidad'], "PRECIO"=> $_PARAM['precio'], "USUARIO" => $_usuario_id));
//		print_r($sql);die;
	}
...
//        $fechaActualizacion = $paramentros['proveedor'];
	...
	function get_subcategoria_bycategoria($_id=0)
	{
