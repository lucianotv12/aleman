...
{ 
	...
	if ($this->id<>0) 
		...
		{
		$sql = $conn->prepare( "insert into clientes_facturas values (null, '$this->idCliente', '$this->idTipo', '$this->n_remito', '$this->n_factura', '$this->descuento', CURDATE(), '$this->importe', '$this->activo', '0', '$this->condicion_venta', '$this->condicion_iva', '$this->orden_compra', '$this->estado' )"); 
		$sql->execute();
